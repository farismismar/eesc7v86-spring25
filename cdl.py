...
def _generate_cdl_a_channel(N_sc, N_r, N_t, sigma_dB, carrier_frequency, G=None, delay_spread=5e-6, num_clusters=23, cASD=5.0, cASA=11.0, cZSD=3.0, cZSA=3.0, xpr=10.0):
    ...
    large_scale_fading = 10 * np.log10(G)
    shadow_fading = np_random.normal(0, np.sqrt(sigma_dB), size=(N_sc, N_r, N_t))
    fading = 10 ** ((large_scale_fading - shadow_fading) / 10.)
...
def _generate_cdl_c_channel_v2(N_sc, N_r, N_t, sigma_dB, carrier_frequency, G=None):
    global np_random
...
def _generate_cdl_e_channel_v2(N_sc, N_r, N_t, sigma_dB, carrier_frequency, G=None, delay_spread=5e-6, num_clusters=23, cASD=5.0, cASA=11.0, cZSD=3.0, cZSA=3.0, xpr=10.0):
    global np_random
